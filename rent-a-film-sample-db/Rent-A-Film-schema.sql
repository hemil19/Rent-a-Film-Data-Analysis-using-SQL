...
DROP SCHEMA IF EXISTS rentafilm;
CREATE SCHEMA rentafilm;
USE rentafilm;
...
GROUP_CONCAT(DISTINCT CONCAT(c.name, ': ',
		(SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR ', ')
                    FROM rentafilm.film f
                    INNER JOIN rentafilm.film_category fc
                      ON f.film_id = fc.film_id
                    INNER JOIN rentafilm.film_actor fa
...
AS film_info
FROM rentafilm.actor a
LEFT JOIN rentafilm.film_actor fa
  ON a.actor_id = fa.actor_id
LEFT JOIN rentafilm.film_category fc
  ON fa.film_id = fc.film_id
LEFT JOIN rentafilm.category c
